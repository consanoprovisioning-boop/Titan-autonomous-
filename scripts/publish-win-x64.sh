...
cp -f "$ROOT/deploy/alienware-local-program/CHECKIN.cmd" "$ROOT/dist/titan-chief-win-x64/CHECKIN.cmd"
cp -f "$ROOT/deploy/alienware-local-program/START-HERE.txt" "$ROOT/dist/titan-chief-win-x64/START-HERE.txt"
(
